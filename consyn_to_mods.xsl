...
<xsl:stylesheet version="2.0" xmlns="http://www.loc.gov/mods/v3"
    ...
    <xd:doc id="credits" scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Last modified on:</xd:b>December 14, 2022</xd:p>
            ...
            <xd:p><xd:b>Modification:</xd:b>added template bam:vorAvailableOnline -
                now top priority date for mods:origin/dateIssued</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xd:doc>
        <xd:desc>
            <xd:p>format attribute called "archive-original". Copies source document. The originalFilename is modified to start with an A- and end with the xml documents position</xd:p>
    ...
    <xsl:template match="/">
       ...
       <xsl:result-document method="xml" encoding="URF-8" indent="yes" href="file:///{$workingDir}N-{replace($originalFilename, '(.*/)(.*)(\.xml)', '$2')}_{position()}.xml">
        <mods version="3.7">
    ...
    <xd:doc>
        <xd:desc>
            ...
            <xd:p><xd:b>Update: cm3 2022-12-14</xd:b>Elsevier added two new elements to each CONSYN file.
            This changes the order of precedence to prefer bam:vorAvailableOnline as mods:originInfo/dateIssued</xd:p>
        </xd:desc>
    </xd:doc>
        ...
        <originInfo>
            <xsl:choose>
                <xsl:when test="/doc:document/rdf:RDF/rdf:Description/dp:availableOnlineInformation/bam:vorAvailableOnline">
                    <xsl:apply-templates select="/doc:document/rdf:RDF/rdf:Description/dp:availableOnlineInformation/bam:vorAvailableOnline"
                        mode="origin"
                      />
                </xsl:when>
    ...
    <!-- cm3 2022-12-14: added new CONSYN element as preferred dateIssued -->
